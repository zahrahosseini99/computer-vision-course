...
notebook_file = open('HW11.ipynb', 'r')
...
for question in questions:
	...
	while notebook_index < len(notebook['cells']):
		if notebook['cells'][notebook_index]['cell_type'] == 'markdown' and "don't change this cell" in notebook['cells'][notebook_index]['source'][0]:
			notebook_index += 1
			break
		if start_write:
